    ...
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-30 border-b border-ink-100 bg-white/70 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <Link href="/irt-automations" className="flex items-center gap-3 group">
            ...
            <div className="leading-tight">
              <div className="text-sm font-semibold tracking-tight text-ink-900">IRT</div>
      ...
      <footer className="border-t border-ink-100 py-6 text-center text-xs text-ink-400">
        IRT Automation Portal · Built for the team
      </footer>
    </div>
  );
}
